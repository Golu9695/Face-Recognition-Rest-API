...
def restAPI():
    ...
    images = load_images_from_folder("/home/ayush/Documents/homepage/images")
    # print(images)
    images_name = []
    for img in images:
        images_name.append(fr.load_image_file(os.path.join("/home/ayush/Documents/homepage/images", img)))
    encodings = []
